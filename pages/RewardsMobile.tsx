  ...
  return (
    <div className="px-4 py-6 space-y-6">
      <header className="space-y-3">
        <h1 className="text-2xl font-bold tracking-tight text-black font-display">Participation Rewards</h1>
      ...
      <div className="space-y-6">
        <div className="glass-card p-6 space-y-6 border-black/15">
          <div className="space-y-2">
            <h3 className="text-xs font-bold uppercase tracking-wider text-black">Node Identity</h3>
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-[10px] font-mono uppercase">
              <span className="text-black/50">XP Progression</span>
        ...
        <div className="glass-card p-6 space-y-4 border-black/15">
           <h3 className="text-xs font-bold uppercase tracking-wider text-black">Tier Privileges</h3>
           <div className="space-y-2">
             {[
      ...
      <div className="space-y-4">
        <section className="glass-card p-6 space-y-4 border-black/15">
           <div className="flex justify-between items-center">
             <h3 className="text-xs font-bold uppercase tracking-wider text-black">Daily Participation Lotto</h3>
           ...
           <button className="text-[10px] font-mono uppercase text-electric-blue hover:text-black transition-colors">View_Eligibility_Rules</button>
        </section>

        <section className="glass-card p-6 space-y-4 border-black/15">
           <div className="flex justify-between items-center">
             <h3 className="text-xs font-bold uppercase tracking-wider text-black">System Airdrops</h3>
             <span className="px-2 py-1 bg-black/5 border border-black/15 text-[8px] font-mono text-black/50">PENDING</span>
           </div>
           <p className="text-xs text-soft-slate leading-relaxed">
           ...
           <div className="p-4 border border-dashed border-black/15 text-center text-[10px] font-mono text-black/50">No rewards currently pending</div>
        </section>
      </div>

      <footer className="p-6 bg-black/[0.03] border border-black/15 text-center">
