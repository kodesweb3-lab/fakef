  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 space-y-24">
      <header className="space-y-8">
        ...
        <h1 className="text-6xl md:text-7xl font-bold tracking-tight text-black font-display">A Manifesto for Systems Cartographers</h1>
      ...
      <div className="space-y-20">
        <section className="space-y-10">
          <div className="glass-card p-12 relative overflow-hidden">
            ...
            <h2 className="text-3xl font-bold mb-8 tracking-tight text-black font-display">The Illusion of Organicism</h2>
            <div className="space-y-6 text-soft-slate text-lg font-light leading-relaxed">
                ...
                <div className="py-8">
                    <p className="text-2xl font-medium text-black italic tracking-tight">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-4 p-8 border-l border-black/15">
        ...
        <section className="glass-card p-16 text-center border-signal-purple/10">
          <h2 className="text-4xl font-bold mb-6 text-black font-display">Responsibility Always.</h2>
          ...
          <div className="pt-12 text-[10px] font-mono uppercase tracking-[0.5em] text-black/40">
