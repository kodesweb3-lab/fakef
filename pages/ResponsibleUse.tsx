  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 space-y-16 animate-in fade-in duration-500">
      <header className="space-y-6">
        <h1 className="text-4xl font-bold tracking-tight text-white font-display">Responsible Use</h1>
      ...
      <section className="p-10 border border-electric-blue/20 bg-electric-blue/5 glass-card mb-12">
        <h4 className="text-xs font-mono uppercase tracking-widest text-white mb-4">Core Boundary Statement</h4>
      ...
      <section className="space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white uppercase tracking-tight">User Responsibility</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white uppercase tracking-tight">Informational Context</h3>
            <p className="text-sm text-soft-slate leading-relaxed font-light">
        ...
        <div className="glass-card p-10 border border-white/5 space-y-6">
