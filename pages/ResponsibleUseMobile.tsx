  ...
  return (
    <div className="px-4 py-6 space-y-6">
      <header className="space-y-3">
        <h1 className="text-2xl font-bold tracking-tight text-black font-display">Responsible Use</h1>
      ...
      <section className="p-6 border border-electric-blue/20 bg-electric-blue/5 glass-card">
        <h4 className="text-xs font-mono uppercase tracking-wider text-black mb-3">Core Boundary Statement</h4>
      ...
      <section className="space-y-6">
        <div className="space-y-4">
          <div className="space-y-3">
            <h3 className="text-base font-bold text-black uppercase tracking-tight">User Responsibility</h3>
          ...
          <div className="space-y-3">
            <h3 className="text-base font-bold text-black uppercase tracking-tight">Informational Context</h3>
            <p className="text-xs text-soft-slate leading-relaxed font-light">
        ...
        <div className="glass-card p-6 border border-black/15 space-y-4">
          ...
          <p className="text-[10px] font-mono text-black/50 uppercase tracking-wider">
