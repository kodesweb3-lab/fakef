  ...
  return (
    <div className="px-4 py-6 space-y-12">
      <header className="space-y-4">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white font-display">A Manifesto for Systems Cartographers</h1>
      ...
      <div className="space-y-8">
        <section className="space-y-6">
          <div className="glass-card p-6 relative overflow-hidden">
            ...
            <h2 className="text-xl font-bold mb-4 tracking-tight text-white font-display">The Illusion of Organicism</h2>
            <div className="space-y-4 text-soft-slate text-sm font-light leading-relaxed">
                ...
                <div className="py-4">
                    <p className="text-lg font-medium text-white italic tracking-tight">
        ...
        <section className="space-y-4">
          <div className="space-y-3 p-6 border-l border-white/5">
        ...
        <section className="glass-card p-8 text-center border-signal-purple/10">
          <h2 className="text-2xl font-bold mb-4 text-white font-display">Responsibility Always.</h2>
          ...
          <div className="pt-6 text-[9px] font-mono uppercase tracking-wider text-white/10">
