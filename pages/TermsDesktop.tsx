  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 space-y-20">
      <header className="space-y-6">
        <h1 className="text-5xl font-bold tracking-tight text-black font-display">Terms of Use</h1>
      ...
      <div className="space-y-16">
        <section className="space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-black font-display tracking-tight">01. No Illusions</h2>
        ...
        <section className="space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-black font-display tracking-tight">02. Instrument Ownership</h2>
            <p className="text-soft-slate text-lg font-light leading-relaxed">
        ...
        <section className="glass-card p-10 border-l-4 border-l-red-500/40 bg-red-500/5">
          ...
          <ul className="space-y-6 text-sm text-black font-light">
        ...
        <section className="space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-black font-display tracking-tight">03. Revocation Protocol</h2>
            <p className="text-soft-slate text-lg font-light leading-relaxed">
        ...
        <footer className="pt-20 border-t border-black/10 text-center">
            ...
            <div className="mt-8 text-[9px] font-mono text-black/20 uppercase tracking-[1em]">
